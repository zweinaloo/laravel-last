          ...
          <div class="widget widget-padding span12">
            ...
            <div class="widget-body">
			  ...
			  @include('template.error')
                <form class="form-horizontal" role="form" method="POST" id="form1"  action="/LibraryManger/roomUpdate">
				 ...
				 <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input class="span7" type="text" name="libraryname" placeholder="类型(Type)" >
