...
$(function() {
  ...
  // prevent the top menu popover links to make the window scroll up because of href="#" //防止顶部菜单滚动
  $('.visible-desktop #messages, .visible-desktop #notifications').click(function(e){
    ...
    $('.top-menu #messages').popover({
      ...
      placement: 'bottom',
      title: '信息',
      content:'<ul><li><a href="#"><img src="/img/avatars/04.jpg"><span>Today</span><h4>Bill Fernando</h4>这个能用realm</a></li><li><a href="#"><img src="assets/img/avatars/05.jpg"><span>Yesterday</span><h4>Roger White</h4>Did you talk to Andrea? She was looking for you</a></li></ul><div class="popover_footer"><a href="">View all messages</a></div>'
    });
    ...
    $('.top-menu #notifications').popover({
      ...
      placement: 'bottom',
      title: '通知 ',
      content:'<ul><li><a href="#"><img src="/img/avatars/07.jpg"><span>时间测试_今天</span><h4>主题_测试1</h4>测试1 通过!?!.</a></li><li><a href="#"><img src="assets/img/avatars/09.jpg"><span>Yesterday</span><h4>Customer Support</h4>You have 3 new tickets assigned to you.</a></li></ul><div class="popover_footer"><a href="">View all notifications</a></div>'
    });


  // funtion to slide menu out from the left 划动菜单固定在左侧//
  ...
  // collapse function for the widget 控制板折叠功能设置
  ...
  //---- redraw charts/pies/bars if the window is resized-- 如果窗口大小改变,重绘界面//
	var didresize = false;
...
if($('#dashboard_page').length > 0 ){
 ...
 // Welcome notification 欢迎信息设置  
  $.gritter.add({
    // (string | mandatory) the heading of the notification
    title: '欢迎进入图书管理系统',
    // (string | mandatory) the text inside the notification
    text: '1.本图书信息管理系统采用B/S体系结构 <p>2.采用mysql数据库作为数据库服务器</p><p>3.采用php的laravel框架完成设计</p><p>4.应用全新jquery/AJAX技术，所有布局均采用DIV+CSS方式，同等网络环境下速度更快、效率更高。</p>',
    // (string | optional) the image to display on the left
    image: '/img/personal/mushita01.png',
